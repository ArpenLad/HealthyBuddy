...
export default function Page() {
  ...
  useEffect(() => {
    try {
      const resetKey = 'healthybuddy-production-reset-v4'
    ...
    <main className="hb-shell">
      ...
      <section className="hb-content">
        ...
        <div className="page-wrap">
          ...
          {view === 'Analytics' && <AnalyticsView habits={habits} dailyLogs={dailyLogs} streak={streak} />}
        </div>
      </section>
...
function AnalyticsView({ habits, dailyLogs, streak }: any) {
